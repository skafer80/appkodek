                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control required date-picker-chiusura"
                                                name="data_avvio_prevista" type="text" value="{{ old('data_avvio_prevista', is_object($dataAvvioPrevista) ? $dataAvvioPrevista->format('d/m/Y') : $dataAvvioPrevista) }}"
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control required date-picker-fine"
                                                name="data_fine_prevista" type="text" value="{{ old('data_fine_prevista', is_object($dataFinePrevista) ? $dataFinePrevista->format('d/m/Y') : $dataFinePrevista) }}"
