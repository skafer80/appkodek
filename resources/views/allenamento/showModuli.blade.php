...
<!-- Mirrored from file://///192.168.1.230/clickday2025/Sw Alunni/Avviso n. 7_2021113 moduli formativi.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Sep 2025 10:25:48 GMT -->
...
<head>
    ...
    <link href="https://https://fse.regione.sicilia.it/avviso72023/assets/plugins/bootstrap/css/bootstrap.min.css"
        rel="stylesheet" type="text/css" />
    <link href="https://https://fse.regione.sicilia.it/avviso72023/assets/plugins/uniform/css/uniform.default.css"
        rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL STYLES -->
    <link rel="stylesheet" type="text/css"
        href="https://https://fse.regione.sicilia.it/avviso72023/assets/plugins/clockface/css/clockface.css" />
    <link rel="stylesheet" type="text/css"
        href="https://https://fse.regione.sicilia.it/avviso72023/assets/plugins/bootstrap-datepicker/css/datepicker.css" />
    <link rel="stylesheet" type="text/css"
        href="https://https://fse.regione.sicilia.it/avviso72023/assets/plugins/bootstrap-timepicker/css/bootstrap-timepicker.min.css" />
    <link rel="stylesheet" type="text/css"
        href="https://https://fse.regione.sicilia.it/avviso72023/assets/plugins/bootstrap-colorpicker/css/colorpicker.css" />
    <link rel="stylesheet" type="text/css"
        href="https://https://fse.regione.sicilia.it/avviso72023/assets/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" />
    <link rel="stylesheet" type="text/css"
        href="https://https://fse.regione.sicilia.it/avviso72023/assets/plugins/bootstrap-datetimepicker/css/datetimepicker.css" />
    <!-- END PAGE LEVEL STYLES -->

    <!-- BEGIN THEME STYLES -->
    <link href="https://https://fse.regione.sicilia.it/avviso72023/assets/css/style-metronic.css" rel="stylesheet"
        type="text/css" />
    <link href="https://https://fse.regione.sicilia.it/avviso72023/assets/css/style.css" rel="stylesheet" type="text/css" />
    <link href="https://https://fse.regione.sicilia.it/avviso72023/assets/css/style-responsive.css" rel="stylesheet"
        type="text/css" />
    <link href="https://https://fse.regione.sicilia.it/avviso72023/assets/css/plugins.css" rel="stylesheet" type="text/css" />
    <!--link href="https://https://fse.regione.sicilia.it/avviso72023/assets/css/pages/tasks.css" rel="stylesheet" type="text/css"/-->
    <link href="https://https://fse.regione.sicilia.it/avviso72023/assets/css/themes/default.css" rel="stylesheet"
        type="text/css" id="style_color" />
    <link href="https://https://fse.regione.sicilia.it/avviso72023/assets/css/custom.css" rel="stylesheet" type="text/css" />
    <link href="https://https://fse.regione.sicilia.it/avviso72023/assets/css/animate.css" rel="stylesheet" type="text/css" />

    <link rel="stylesheet"
        href="https://https://fse.regione.sicilia.it/avviso72023/assets/plugins/data-tables/DT_bootstrap.css" />
    <!-- END THEME STYLES -->
    <link rel="shortcut icon" href="https://https://fse.regione.sicilia.it/avviso72023/images/favicon.ico" />
...
<body class="page-header-fixed" style="background-color: #f5f5f5!important;">
                ...
                <div class="portlet">
                    ...
                    <div class="portlet-title">
                        <div class="col-md-3 text-left">
                            <ol class="breadcrumb">
                                <a href="" class="btn blue btn-sm"><i
                                        class="fa fa-long-arrow-left fa-5x""
                    ...
                    @if ($player->end_time)
                        <div class="bg-success">
                            ...
                            <a href="{{ route('allenamento.index') }}" class="btn btn-primary">Torna alla classifica</a>
                        </div>
                    @endif
                        ...
                        <tbody id="informationsources">
                            ...
                            <tr id="is-155863">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        ...
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155863)->first()->id]) }}"><span
                            ...
                            <tr id="is-155864">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155864)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155865">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155865)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155866">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155866)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155867">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155867)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155868">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155868)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155869">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155869)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155870">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155870)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155871">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155871)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155872">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155872)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155873">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155873)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155874">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155874)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155875">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155875)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155876">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155876)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155877">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155877)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155878">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155878)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155879">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155879)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155880">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155880)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155881">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155881)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155882">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155882)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155883">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155883)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155884">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155884)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155885">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155885)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155886">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155886)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155887">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155887)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155888">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155888)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155889">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155889)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155890">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155890)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155891">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155891)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155892">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155892)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                            ...
                            <tr id="is-155893">
                                ...
                                <td class="text-right">
                                    <button {{ $player->end_time ? 'disabled' : '' }}
                                        class="btn btn-sm btn-warning editinformationconoscenza"
                                        data-href="{{ route('allenamento.getModulo', ['id' => $subjects->where('id_subject', 155893)->first()->id]) }}"><span
                                            class="glyphicon glyphicon-pencil"></span></button>
                                </td>
                            </tr>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ route('allenamento.editModuli') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control required" id="i_ore_prova" name="ore_conoscenza"
                                            type="number" value="">
                                    </div>
                                    <div class="form-group">
                                        <label for="i_ore_fad" class="control-label">DI CUI IN FAD</label>
                                        <input class="form-control required" id="ore_fad_conoscenza"
                                            name="ore_fad_conoscenza" type="number" value="">
                                    </div>
        ...
        <div class="modal-dialog modal-xs">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="passwordModalLabel">Cambia password</h4>
                </div>
                <div class="modal-body">
                    <div id="passwordAlert" class="alert alert-danger" style="display: none;">
                    </div>

                    <form method="POST" action="https://kodek.it/modulo-conoscenza/passwordchange"
                        accept-charset="UTF-8" id="changePasswordForm"><input name="_token" type="hidden"
                            value="2tSSoF2XI47l94nLPryulIiPhrcvjLkzqfUH3PCT">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="password_confirmation" class="required">Conferma password</label>
                ...
                <div class="modal-footer">
                    <button id="changePasswordBtn" type="button" class="btn dark">Salva</button>
                    <button type="button" class="btn yellow" data-dismiss="modal">Annulla</button>
                </div>
            </div>
        </div>
    ...
    <!-- BEGIN CORE PLUGINS -->
    <!--[if lt IE 9]>
                                <script src="https://kodek.it/modulo-conoscenza/assets/plugins/respond.min.js"></script>
                                <script src="https://kodek.it/modulo-conoscenza/assets/plugins/excanvas.min.js"></script>
                                <![endif]-->
    ...
    <script src="https://fse.regione.sicilia.it/avviso72023/assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js"
        type="text/javascript"></script>
    <script src="https://fse.regione.sicilia.it/avviso72023/assets/plugins/jquery.blockui.min.js"
        type="text/javascript"></script>
    ...
    <script type="text/javascript"
        src="https://fse.regione.sicilia.it/avviso72023/assets/plugins/bootstrap-daterangepicker/moment.min.js">
    </script>
    <script type="text/javascript"
                ...
                $.ajax({
                    ...
                    success: function(data, textStatus, jqXHR) {
                        ...
                        $('#othersources').append('<div id="os-' + data.data.id +
                            ...
                            'MD' + data.data.id + '<br/>\n\
                                                        <button class="btn blue editothersource" data-id="' + data.data
                            .id +
                            '">Modifica</button>' +
                            '</div>' +
                            '<div class="col-xs-3 col-md-3 col-lg-3">' +
...
<!-- Mirrored from file://///192.168.1.230/clickday2025/Sw Alunni/Avviso n. 7_2021113 moduli formativi.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Sep 2025 10:25:56 GMT -->
